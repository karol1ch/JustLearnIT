...
<div class="container">
    ...
    <form:form action="submitCode" id="ideForm" method="post" modelAttribute="submit">
        <div class="card border-primary mb-3">
            ...
            <div class="card-body">
                <form:textarea path="userCode" style="display:none;"/>
            ...
            <div class="card-footer">
                ...
                <div class="row">
                    <div class="col">
                        <form:select id="languageSelect" class="selectpicker form-control" path="language" style="float: left; margin: 16px; width: 50%" onchange="updateLanguage(this)">
