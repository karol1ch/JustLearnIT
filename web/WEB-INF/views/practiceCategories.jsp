            ...
            <div class="card-body">
                <form:form modelAttribute="categories">
                    <c:forEach items="${categories}" var="category">
                        ...
                        <a href="/practice/category/${category.name}" class="list-group-item list-group-item-action flex-column align-items-start" style="margin-bottom: 16px; margin-top: 16px">
